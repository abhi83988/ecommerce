...
export default function SigninPage() {
  ...
  async function handleGoogleLogin() {
    ...
    await signIn("google", { callbackUrl: "/customer/products" });
  }
      ...
      <div className="bg-white shadow-2xl rounded-3xl p-8 w-full max-w-md flex flex-col gap-6
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-5">
          <input
            ...
            name="email"
            placeholder="Email"
            className="border text-black border-gray-300 p-4 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500 transition placeholder-gray-400"
            required
          />
          <input
            type="password"

    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      ...
      <div className="max-w-5xl mx-auto p-6">
        ...
        <div className="bg-white shadow-lg rounded-2xl p-6 mb-10">
          <h2 className="text-lg text-black font-semibold text-gray-700 mb-4 flex items-center gap-2">
          ...
          <div className="space-y-4">
            <input
              ...
              className="w-full text-black border p-3 rounded-lg focus:ring-2 focus:ring-green-400 outline-none"
            />
            <textarea

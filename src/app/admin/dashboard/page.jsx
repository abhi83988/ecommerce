    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="max-w-7xl mx-auto px-6 py-10">
        ...
        <div className="mt-12 bg-white shadow rounded-xl p-6 overflow-x-auto">
          <h2 className="text-xl text-black font-semibold mb-4">Recent Orders</h2>
          <table className="w-full border-collapse text-sm">
            <thead>
              <tr className="bg-gray-100 text-left">
                <th className="p-3 text-black">Order ID</th>
                <th className="p-3 text-black">User ID</th>
            ...
            <tbody>
              {recentOrders.length === 0 ? (
                <tr>
                  <td colSpan="4" className="p-3 text-black text-center text-gray-500">
                    No orders found
                  </td>
                </tr>
              ) : (
                recentOrders.map((order, i) => (
                  ...
                  >
                    <td className="p-3 text-black font-medium">#{order.id}</td>
                    <td className="p-3 text-black">{order.user_id}</td>
                    ...
                    <td className="p-3 text-black font-semibold">₹{order.total_amount}</td>
                  </tr>
                ))
              )}
            </tbody>

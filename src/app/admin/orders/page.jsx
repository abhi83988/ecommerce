        ...
        {orders.length > 0 ? (
          orders.map((order) => (
            ...
            >
              ...
              <td className="p-4 text-black">{order.customer_name}</td>
              ...
              <td className="p-4">
                <select
                  ...
                  className="border text-black rounded-lg px-3 py-1 text-sm focus:ring-2 focus:ring-blue-400 bg-gray-50 cursor-pointer hover:border-blue-400 transition"
                >

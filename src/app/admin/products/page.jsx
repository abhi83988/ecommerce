        ...
        <div className="bg-white shadow-lg rounded-2xl p-6 mb-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            <input
              ...
              className="border p-3 text-black rounded-lg focus:ring-2 focus:ring-blue-400 outline-none"
            />
            <input
              type="number"
              placeholder="Price"
              ...
              className="border text-black p-3 rounded-lg focus:ring-2 focus:ring-blue-400 outline-none"
            />
            <input
              type="number"
            ...
            <textarea
              ...
              className="border text-black p-3 rounded-lg focus:ring-2 focus:ring-blue-400 outline-none col-span-1 md:col-span-2"
            />
            <select
